...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({
      ...
      name: `Buy ${recipient.name || recipient.username} a chai`,
      description: message ? `Message: "${message}"` : 'Support this creator',
      image: recipient.profilepic || 'https://via.placeholder.com/300x300?text=Chai',
      prefill: {
        name: name
      },
      theme: {
